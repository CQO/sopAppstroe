...
enum {
	...
	err_forbid = 1304 , //
	//<--------------SDK自定义错误---------------->
	err_sdk_start = 0xFF000000 ,
	err_sdk_openDbFailed,//打开本地数据库失败
	err_sdk_srvUpdate,   //正在更新
	...
	err_sdk_rcOverdue=0xFF00000A,//资源已过期
	err_sdk_tooOften,
	err_sdk_licTypeFail,//证书权限不够
    ...
    err_setMsgreaded_invalidMsgid = 0xFF000010,//设置已读消息号大于最大消息ID
	...
	err_sdk_noAchieve=0xFF000015, //命令没有实现
    ...
    err_sdk_p2pNotReach = 0xFF00001A,///对方不可达
    ...
    err_sdk_noMsgs = 0xFF000020,//本地数据库没有消息
    ...
    err_sdk_systemBusy = 0xFF00002A, //系统正忙
	err_sdk_alreadyIn, //被邀请的人已经在会议中
	err_sdk_noConference, //本地会议不存在
	err_sdk_ownerDiscon, //房主已经断开
	err_sdk_tryLater,    //稍后再请求
    err_sdk_rtcBusy,         // 已在会议中
	err_sdk_alreadyExec, ///已经执行中
    err_sdk_notOwner = 0xFF000030,///不是房主 非法操作
